...
<div class="row">
    <div class="col-lg-12">
        <div class="card">
            ...
            <div class="card-body">
                <form action="/admin/{{$datane->id}}/ubahprofilgo" method="post" enctype="multipart/form-data">
                    {{csrf_field()}}
                    <div class="form-body">
                        <div class="row">
                                <div class="col-md-12">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <input type="file" name="file" id="input-file-max-fs" class="dropify" data-max-file-size="20M" accept=".jpg, .png, .jpeg, .gif, .bmp, .tif, .tiff|image/*" /> </div>
                                </div>
                            </div>
                    </div>
